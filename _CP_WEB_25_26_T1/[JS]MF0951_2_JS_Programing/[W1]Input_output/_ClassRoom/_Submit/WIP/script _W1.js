...
console.log("La suma dels dos numeros es : " +  (aritmet1 + aritmet2) );
console.log("La resta dels dos numeros es : " + (aritmet1 - aritmet2 ));
console.log( "La multiplicacion dels dos numeros es : "  + (aritmet1 * aritmet2 ));
console.log( "La multiplicacion dels dos numeros es : " + (aritmet1 / aritmet2 ));
